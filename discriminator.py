...
class CNNDiscriminator(nn.Module):
    ...
    def forward(self, inp):
        ...
        # feature.register_hook(lambda g: print('!!!feature grad shape: ', g.shape) )
    ...
    def get_feature(self, inp):
        ...
        # emb.register_hook(lambda g: print('@@@emb grad max:{}, min:{} '.format(g.max(), g.min())) )
        # print('!!!!embed_dim: ', emb.shape) 
        # print('!!!!feature_dim', self.feature_dim) 1720
